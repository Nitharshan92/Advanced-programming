                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-outline-primary">Rs. <%= p.getPriceAfterApplyingDiscount() %>/=<span class="text-secondary discount-label">Rs. <%= p.getpPrice() %>, <%= p.getpDiscount() %>% off</span></button>
                                    </div>
                                </div>
                                <%
                                    }
